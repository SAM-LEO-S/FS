...
ts = TimeSeries(key='K9VHHDQ753WTXHU4.', output_format='pandas') #key from alphavintage.co
...
try:
    ...
    if last_price > target_sell_price:
            ...
            server.starttls()
            server.login("youremail@gmail.com", "google app password") 
            print("Login Success")
            ...
            Message = client.messages.create(
                                    ...
                                    to ='#your number',#your number should be entered
